...
export function fViewExpandedElbit() {
  return (
    <View style={CVStyles.item}>
      <View>
        ...
        />
        <Text style={CVStyles.title}>{GetString(EnumStringKeys.CV_Task_Elbit)}</Text>
      </View>
      <Text style={CVStyles.row}>{GetString(EnumStringKeys.CV_Elbit_Development)}</Text>
      <Text style={CVStyles.rowunder}>{GetString(EnumStringKeys.CV_Elbit_Work)}</Text>
    </View>
  );
}

export function fViewCollapsedElbit() {
  return (
    <View style={CVStyles.item}>
      <View>
        <Image
