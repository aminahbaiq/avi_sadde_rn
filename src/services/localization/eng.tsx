...
export const eng: EnumStringKeysDict = {
  [EnumStringKeys.Home_Title]: 'Avi Sadde - SW Engineer',
  ...
  [EnumStringKeys.CV_Personal_Address_Caption]: 'Address:',
  [EnumStringKeys.CV_Personal_Address]: 'Avital 7, Yoqneam Illit',
  ...
  [EnumStringKeys.CV_Languages_Hebrew_Caption]: 'Hebrew:',
  [EnumStringKeys.CV_Languages_Hebrew]: 'Mother Tongue',
  [EnumStringKeys.CV_Languages_English_Caption]: 'English:',
  [EnumStringKeys.CV_Languages_English]: 'High level of speaking, reading and writing',
  ...
  [EnumStringKeys.CV_Summary_27_Years_Short]: 'For 27 years as a software engineer...',

  [EnumStringKeys.CV_Section_WorkExperience]: 'Work Experience',

  [EnumStringKeys.CV_Task_MyRecord]: '2021-2023 My Record',
  [EnumStringKeys.CV_MyRecord_MVP_1x]: 'Version MVP 1.x (open to general public)',
  ...
  [EnumStringKeys.CV_MyRecord_MVP_0x]: 'Version MVP 0.x (“LAB” - Limited target audience)',
  [EnumStringKeys.CV_MyRecord_MVP_0x_Development]:
    'Development of “My Record” App based on “Vánaga” app.',
  [EnumStringKeys.CV_MyRecord_MVP_0x_1]: 'A social network based on audio stories.',
  ...
  [EnumStringKeys.CV_SanDisk_Oscar_GUI]:
  ...
  [EnumStringKeys.CV_ImpulseDynamics_Env]: 'Work on Windows NT 4.0, Visual C++ 6.0.',
  ...
  [EnumStringKeys.CV_Technion_Specialization]: 'Specialization in software engineering',
  [EnumStringKeys.CV_Technion_Grade]: ' (Cumulating grade 77.7)',
  ...
  [EnumStringKeys.CV_Bosmat_Practical_Electrical_Engineering]:
    'Practical Electrical Engineering degree ',
  [EnumStringKeys.CV_Bosmat_Excellent_Student]: '(an excellent student) ',
  [EnumStringKeys.CV_Bosmat_Project_1]: 'Project for the Practical Engineer degree: ',
  [EnumStringKeys.CV_Bosmat_Project_2]:
    'Built a computerized velocity controller for 8 stress channels - ',
  [EnumStringKeys.CV_Bosmat_Project_Grade]: 'project grade: 100',
  [EnumStringKeys.CV_Bosmat_Bagrut]: '1984-1987 Bosmat High School: Full Bagrut',
  ...
  [EnumStringKeys.Gallery_AhuTongariki]: 'Ahu Tongariki - Rapa Nui (Easter Island)',
  ...
  [EnumStringKeys.Gallery_TrwynDuLighthouse]: 'Trwyn Du Lighthouse (Penmon Point, UK)',
  ...
  [EnumStringKeys.Links_Vanaga]: 'Vánaga (app)',
  ...
  [EnumStringKeys.Phone_Permissions_Title]: 'Call Phone Permission',
  [EnumStringKeys.Phone_Permissions_Message]: 'The app needs access to your phone to dial to Avi',
  [EnumStringKeys.Phone_Permissions_ButtonNeutral]: 'Ask Me Later',
  [EnumStringKeys.Phone_Permissions_ButtonNegative]: 'Cancel',
